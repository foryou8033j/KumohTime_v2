  ...
  render() {
    return (
      <div class="row">
        <div class="col s8">
          <Card>
            <table className={`black-text striped highlight responsive-table ${styles.lectureTable}`}>
              <thead>
                <tr>
                  <th>#</th>
                  <th>년도</th>
        ...
        <div class="col s4">
          <Card>
            <div class="center">
            <h5 className={`black-text  ${styles.timeTableHeader}`}>TimeTable</h5>
            </div>
            <div className={styles.tab}>
              <table border="0" cellpadding="0" cellspacing="0" id="timetable">
